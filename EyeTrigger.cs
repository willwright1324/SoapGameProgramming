...
public class EyeTrigger : MonoBehaviour {
    ...
    void Start() {
        ...
        xOffset = eyes.transform.localPosition.x;
        yOffset = eyes.transform.localPosition.y;
        zOffset = eyes.transform.localPosition.z;
        xOffset2 = eyes.transform.localPosition.x;
        yOffset2 = eyes.transform.localPosition.y;
        zOffset2 = eyes.transform.localPosition.z;
    }
